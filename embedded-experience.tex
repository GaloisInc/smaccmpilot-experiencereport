...
approximately 50k of C code generated from 10k of EDSL code and includes control
...
gains of EDSLs.  This is the story of how EDSLs provided the productivity and
safety gains to do large-scale low-level embedded programming and lessons we
learned in doing so.
\end{abstract}
