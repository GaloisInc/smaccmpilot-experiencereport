...
During development, it slowly become apparent how useful Haskell type-checking
...
\cd{IBool}, which is the type of a Boolean, in Ivory.  With the \cd{cond\_}
...
sizes, like \cd{int} or \cd{char} are not available.  We have found these to be
