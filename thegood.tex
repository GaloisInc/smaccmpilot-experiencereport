...
instantaneously. The type system tracks the global or stack frame provenance of
...
structures that are defined at the top-level are ``packaged'' into a \cd{Module}
