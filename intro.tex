...
all, our project involved some \todo{XXX} lines of Haskell-hosted EDSL code that
generates \todo{YYY} lines of embedded C.  It is one of the largest and most
...
compilers from scratch in approximately \todo{XXX} engineer-months then we used
them to build SMACCMPilot in another \todo{YYY} engineer-months.  We achieved a
...
\todo{Indeed, a number of
researchers have explored EDSLs for generating embedded C code, such as
Atom~cite{}, Feldspar~\cite{}, Copilot~\cite{}, \todo{more}.  However, these
languages are still at the application level
}

\todo{In this experience report, we describe lessons learned in the use of EDSLs to
